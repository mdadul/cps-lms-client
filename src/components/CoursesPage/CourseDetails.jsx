    ...
    <div className="w-screen h-screen overflow-hidden">
      <div className="mx-auto max-w-screen-lg px-3 py-10">
        <div className="space-y-3">
          <h5 className="text-sm font-medium uppercase text-gray-400">WEB DEVELOPMENT Basic</h5>
          <h1 className="text-3xl font-semibold">Web Development for Beginners</h1>
          <p className="">Welcome to "Cholo Programming Shikhi- CPS" web development course for beginners! This course is designed to teach you the fundamentals of web development and help you build a solid foundation in HTML, CSS, Bootstrap, JavaScript, PHP, and SQL. Whether you're a student, a job seeker, or someone looking to expand their skill set, this course is perfect for you!</p>
