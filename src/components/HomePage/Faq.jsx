      ...
      <ul className="space-y-4">
        ...
        <li className="text-left">
          ...
          >
            ...
            <div className="relative ml-4 cursor-pointer select-none items-center py-4 pr-12">
              <h3 className="text-sm text-gray-600 lg:text-base">
              What programming languages are covered in <b> Programming Shikho</b> Platform?
              </h3>
            </div>
            <div className="max-h-0 overflow-hidden transition-all duration-500 peer-checked:max-h-96">
              <div className="p-5">
                <p className="text-sm">
                  <b> Programming Shikho</b> offers courses in several programming languages, including <b>C, C++, Problem Solving</b>, Python, Java and JavaScript. We have <b>Web Design and Development Courses</b> as well to help you learn the basic to advance of web development.
                </p>
              </div>
            </div>
          </label>
        ...
        <li className="text-left">
          ...
          >
            ...
            <div className="relative ml-4 cursor-pointer select-none items-center py-4 pr-12">
              <h3 className="text-sm text-gray-600 lg:text-base">
              How much does it cost to enroll in Programming Shikho's courses?
              </h3>
            </div>
            <div className="max-h-0 overflow-hidden transition-all duration-500 peer-checked:max-h-96">
              <div className="p-5">
                <p className="text-sm">
                 The cost of each course varies, but  <b> Programming Shikho</b> offers both free and paid courses. You can check the course page for pricing details.
                </p>
              </div>
            </div>
          </label>
        ...
        <li className="text-left">
          ...
          >
            ...
            <div className="relative ml-4 cursor-pointer select-none items-center py-4 pr-12">
              <h3 className="text-sm text-gray-600 lg:text-base">
              Do I need any prior programming experience to enroll in Programming Shikho's courses?
              </h3>
            </div>
            <div className="max-h-0 overflow-hidden transition-all duration-500 peer-checked:max-h-96">
              <div className="p-5">
                <p className="text-sm">
                No, <b> Programming Shikho</b>'s courses are designed for both beginners and experienced programmers. The courses cover the basics of programming as well as more advanced topics.
                </p>
              </div>
            </div>
          </label>
        ...
        <li className="text-left">
          ...
          >
            ...
            <div className="max-h-0 overflow-hidden transition-all duration-500 peer-checked:max-h-96">
              <div className="p-5">
                <p className="text-sm">
                Yes, Programming Shikho provides a certificate of completion for each course. You can download and print your certificate once you have successfully completed the course.
                </p>
              </div>
            </div>
          </label>
        ...
        <li className="text-left">
          ...
          >
            ...
            <div className="max-h-0 overflow-hidden transition-all duration-500 peer-checked:max-h-96">
              <div className="p-5">
                <p className="text-sm">
                Yes, Programming Shikho provides opportunities for students to interact with instructors and other students through forums, live chat sessions, and other online resources.
                </p>
              </div>
            </div>
          </label>
